...
#ifndef PROPAGATEANDUPDATE_HPP_
#define PROPAGATEANDUPDATE_HPP_
  ...
  */
  ...
  /** 
  *   @brief  Quaternion Propagation
  *  
  *   @param  wbi_B is the angular velocity projected to the body frame
  *   @param  dtGryo is the gyro sample time
  *   @param  q_BI is the current estimate of the quaternion.  q_BI will be propagated in this function.
  *   @return void
  */ 
...
void* propagateANDupdate(void *pArg);      ///< State and State Covariance Propagation and Update function
