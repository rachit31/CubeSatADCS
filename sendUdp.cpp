...
const char* SendUdp::initialize(const char* localIp, const char* remoteIp, const uint16_t sendPort)
{
...
const char* SendUdp::sendDoubles(const double* buffer, const int number) const
{
  if (m_socketFd == -1)
  {
